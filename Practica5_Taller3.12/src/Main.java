...
public class Main {
    public static void main(String[] args) {
        ...
        factura.setNumeroPieza(JOptionPane.showInputDialog("Ingrese el numero de pieza"));
        factura.setDescripcionPieza(JOptionPane.showInputDialog("Ingrese la descripcion de la pieza"));
        factura.setCantidad(Integer.parseInt(JOptionPane.showInputDialog("Ingrese la cantidad de articulos::")));
        factura.setPrecio(Double.parseDouble(JOptionPane.showInputDialog("Ingrese el precio:")));
